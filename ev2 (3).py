...
while True:
    ...
    if opciones_1 == 1:
        ...
        for lista in listas_datos_finales:
            for fecha in lista_reservaciones:
                if fecha == fecha_procesada:
                    ...
                    print("*"*80)
                    print(lista_reservaciones.values())
                    print("*"*50)
      ...
      nuevo_cliente = clientes.append(input("Inserte su nombre:\n "))
      clave_unica = clientes.append(print(f"Su clave es {random.randrange(1000000)}\n"))
  
    elif opciones_1 == 5:
        clave_sala = sala.append(str(random.randrange(10000)))
        if clave_sala == None:
            nombre_sala = sala.append(input("Ingresa el nombre de la sala\n"))
            print("Sala agregada:")
            print(sala)
        else:
            print("Debe registrar una nueva sala\n")
